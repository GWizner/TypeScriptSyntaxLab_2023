...
todoSubmit.addEventListener('click', 
    ...
    // We must add a function here. This function will be called each time a 'click' on the submit button 
    //is observed.
    // The 'click' even is captured as an object and can be passed in to the function.
    function(event) {
    
        // Call 'preventDefault()' to prevent the browser from refreshing (the default behaviour when a 
        //link is clicked)
